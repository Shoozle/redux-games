...
export const gameImagesURL = (game_id) => `${base_url}/${game_id}/screenshots${base_key_url}`

export const SearchGameURL = (game_name) => `${base_url}${base_key_url}&search=${game_name}&page_size=9`;
